 ...
 */
@WebServlet(
        name = "TownVillageListModify",
        urlPatterns = {"/townVillageListModify.do"},
        initParams = {
            @WebInitParam(name = "SUCCESS_VIEW", value = "message.do")
            ,
            @WebInitParam(name = "ERROR_VIEW", value = "message.do")
        })
public class TownVillageListModify extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        TownVillageList townVillageList = new TownVillageList(parseInt(num), townName, villageName);
        townVillageService.modifyTownVillageList(townVillageList);
